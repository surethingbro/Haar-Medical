    ...
    return (
        <section id="inicio" className='flex items-center justify-center '>
            <div className=" px-5 text-center py-5 sm:px-10 xmd:px-20 flex-col">
                <h1 className='text-sm  xsm:text-[1.188rem] xmd:text-3xl sm:text-2xl text-center font-mont-medium text-white uppercase'>Más que estética, <br/>
                <span className=" font-bold px-3">es confianza.</span> </h1>
                
                <p className='font-mont-regular text-white text-center text-[0.5rem] xsm:text-[0.813rem] sm:text-xs xmd:text-base mt-2 px-3 w-fit px-2'>
